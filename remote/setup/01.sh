...
# Grant privileges on the public schema to the greenlight user.
sudo -i -u postgres psql -d greenlight -c "GRANT USAGE, CREATE ON SCHEMA public TO greenlight"
sudo -i -u postgres psql -d greenlight -c "ALTER ROLE greenlight SET search_path TO public"

# Set the greenlight user as the owner of the database.
